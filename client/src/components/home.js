...
const initialHeaderValues = {
  header: 'सत्त्या 8 PM सट्टा बाज़ार',
  subHeading: 'आज का बाजार भाव',
  brandName: 'Your brand name can come here!',
  oldCode: '',
  newCode: '',
  tableHeader: 'सत्त्या 8 PM सट्टा बाजार लॉटरी चार्ट दिसंबर 2023',
...
let oldDetail = []
for (let i = 23; i < 24; i++) {
  oldDetail.push({ desc: `Satya 8pm  Satta King Chart 20${i}` })
}
let oldDataWithCity = []
for (let i = 0; i < [...new Set(...apiData.map(x => x.cities.map(y => y.name)))].length; i++) {
  ...
  oldDataWithCity.push({ desc: `Satya 8pm  satta king Chart ${element}` })
}
    ...
    <>
      ...
      <div className="row mx-3 my-5 py-2 px-2" style={{ backgroundColor: '#c3dbf1' }}>
       ...
       <div className='px-2 mt-5'>
          <p>Satya 8pm  Satta King Result Chart 2022</p>
          <p>Results for Satya 8pm , Satya 8pm  Satta King game, new result for Bikaner, old result for Satya 8pm  game, king sBikaner game chart 2022, Satya 8pm  result record chart for today, king Satya 8pm , Satya 8pm  result, Satya 8pm  king, king Satya 8pm  result, Satya 8pm  number, king Satya 8pm  chart, Satya 8pm result, Satya 8pm bazar, Satya 8pm Satta and all game results can be found here monthly. We have monthly and yearly bashed results data and its update only from the company authorized members. Please bookmark this website page and get the update on time. Hope you enjoy your game and earn money without any issue, if you have any query or problem feel free to contact with our Khaiwal or online playing person we will work on your query and will short out very soon.
